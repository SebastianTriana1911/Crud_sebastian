...
<body>
    @section("content")
        <br>
        <div class="container">
            <h1>Form of update Candidate</h1>
            <br>
            ...
            <div class="mb-3">
                ...
                <input id="user_id" class="form-control" type="number" name="user_id" value="{{ old('user_id', $candidates -> user_id) }}"/>
            ...
            <div class="mb-3">
                ...
                <input id="points" class="form-control" type="number" name="points" value="{{ old('points', $candidates -> points) }}"/>
